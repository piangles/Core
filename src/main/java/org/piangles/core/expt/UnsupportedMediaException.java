...
/**
 * 
 * The user sent across media that is not supported, ex: We only support gif/jpeg/png/bmp and user sent tiff.
 * Translates to HTTP StatusCode - 415 
 */
public class UnsupportedMediaException extends ServiceRuntimeException
{
