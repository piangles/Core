...
/**
 * 
 * The user is trying to upload a file that is too large.
 * Translates to HTTP StatusCode - 413 
 */
public class PayloadTooLargeException extends ServiceRuntimeException
{
