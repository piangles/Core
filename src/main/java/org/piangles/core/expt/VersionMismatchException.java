...
/**
 * 
 * The user provided stale data for the resource, the resource was updated.
 * Translates to HTTP StatusCode - 409. 
 */
public class VersionMismatchException extends ServiceRuntimeException
{
